...
public class ReceptionistLogin extends JFrame {
    ...
    public ReceptionistLogin() {
        ...
        jLabel4.setText("Receptionist Login Panel");
        jPanel3.add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 60, -1, 40));
     ...
     private void jButton1ActionPerformed(ActionEvent e){
       if(e.getSource()== jButton1){
          if((jTextField1.getText().compareTo("Receptionist")==0)&&(jPasswordField1.getText().compareTo("12345678")==0)){
              ReceptionistPortal RP = new ReceptionistPortal();
              RP.setVisible(true);
              this.dispose();
          }
          else{
